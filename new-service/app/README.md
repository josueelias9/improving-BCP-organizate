...
erDiagram
    ...
    DOCUMENT {
        ...
        string plain_text
        string path "mmm... not sure if this has any relevant meaning. Analyze"
    }
    ...
    DOCUMENT_FORMAT ||--o{ DOCUMENT : "there are several standard formats in which the document is presented"
