...
class BCPCreditParser:
    ...
    def get_data(self, full_text: str) -> dict:
        ...
        try:
            ...
            saldo_anterior_soles, saldo_anterior_dolares = self.extract_saldo_anterior(full_text)
    ...
    def extract_saldo_anterior(text: str) -> tuple[float, float]:
        ...
        try:
            ...
            if match:
                ...
                logger.info(f"Extracted previous balance - Soles: {soles}, Dolares: {dolares}")
        ...
        for line_num, line in enumerate(lines):
            ...
            try:
                ...
                if match:
                    ...
                    transaction = {
                        "fecha_valor": fecha_transaccion.isoformat() if fecha_transaccion else None,
                        "fecha_proceso": fecha_proceso.isoformat() if fecha_proceso else None,
